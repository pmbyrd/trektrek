...
def write_html_to_file(url, filename):
    # Make a request to the website
    r = requests.get(url)
    r_html = r.text

    # Write the HTML contents to a new file
    with open(filename, 'w') as f:
        f.write(r_html)

# Usage
write_html_to_file('https:/dd/www.example.com', 'output.html')
