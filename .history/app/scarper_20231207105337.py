...
class Scraper:
    ...
    def get_aside(self):
        ...
        Returns: None if there is no aside section
        Returns: The soup object if there is an aside section
        """
        soup = self.soup()
        try: 
            div = soup.find("div", {"class": "mw-parser-output"})
    ...
    def get_source(self):
        ...
        print(aside)
        print(aside.__class__)
        print("**********************************************")
        #Find all classes with pi-
        print("**********************************************")
        source = aside.find("div", {"class": "pi-category-source"})
        # print(aside.find_all("div"))
